                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    __m256           dx30,dy30,dz30,rsq30,rinv30,rinvsq30,r30,qq30,c6_30,c12_30,dms_r30;
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
	    ...
	    #ifdef SHIFT_FORCES
	    	dms_r30	= _mm256_sqrt_ps(rsq30);
	   	dms_r30     = _mm256_add_ps(dms_r30, dms_epsilon);
	    	rsq30	= _mm256_mul_ps(dms_r30, dms_r30);
	    #endif
