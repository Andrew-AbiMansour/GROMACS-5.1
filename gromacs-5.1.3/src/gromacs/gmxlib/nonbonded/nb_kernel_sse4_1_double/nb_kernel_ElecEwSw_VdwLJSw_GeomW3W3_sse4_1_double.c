                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    __m128d          dx01,dy01,dz01,rsq01,rinv01,rinvsq01,r01,qq01,c6_01,c12_01,dms_r01;
    __m128d          dx02,dy02,dz02,rsq02,rinv02,rinvsq02,r02,qq02,c6_02,c12_02,dms_r02;
    __m128d          dx10,dy10,dz10,rsq10,rinv10,rinvsq10,r10,qq10,c6_10,c12_10,dms_r10;
    ...
    __m128d          dx20,dy20,dz20,rsq20,rinv20,rinvsq20,r20,qq20,c6_20,c12_20,dms_r20;
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            #ifdef SHIFT_FORCES
                dms_r01     = _mm_sqrt_pd(rsq01);
               	dms_r01     = _mm_add_pd(dms_r01, dms_epsilon);
       	        rsq01       = _mm_mul_pd(dms_r01, dms_r01);
            #endif

            rsq02            = gmx_mm_calc_rsq_pd(dx02,dy02,dz02);
	
            #ifdef SHIFT_FORCES
                dms_r02     = _mm_sqrt_pd(rsq02);
               	dms_r02     = _mm_add_pd(dms_r02, dms_epsilon);
       	        rsq02       = _mm_mul_pd(dms_r02, dms_r02);
            #endif

            rsq10            = gmx_mm_calc_rsq_pd(dx10,dy10,dz10);
	
            #ifdef SHIFT_FORCES
                dms_r10     = _mm_sqrt_pd(rsq10);
               	dms_r10     = _mm_add_pd(dms_r10, dms_epsilon);
       	        rsq10       = _mm_mul_pd(dms_r10, dms_r10);
            #endif
            ...
            #ifdef SHIFT_FORCES
                dms_r20     = _mm_sqrt_pd(rsq20);
               	dms_r20     = _mm_add_pd(dms_r20, dms_epsilon);
       	        rsq20       = _mm_mul_pd(dms_r20, dms_r20);
            #endif
