                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    #ifdef SHIFT_FORCES
        __m256d dms_epsilon  = _mm256_set1_pd(SHIFT_FORCES); // reduce forces by shifting the interatomic distance with 'epsilon'
    #endif
    ...
    __m256d          dx00,dy00,dz00,rsq00,rinv00,rinvsq00,r00,qq00,c6_00,c12_00,dms_r00;
    __m256d          dx11,dy11,dz11,rsq11,rinv11,rinvsq11,r11,qq11,c6_11,c12_11,dms_r11;
    __m256d          dx12,dy12,dz12,rsq12,rinv12,rinvsq12,r12,qq12,c6_12,c12_12,dms_r12;
    __m256d          dx13,dy13,dz13,rsq13,rinv13,rinvsq13,r13,qq13,c6_13,c12_13,dms_r13;
    __m256d          dx21,dy21,dz21,rsq21,rinv21,rinvsq21,r21,qq21,c6_21,c12_21,dms_r21;
    __m256d          dx22,dy22,dz22,rsq22,rinv22,rinvsq22,r22,qq22,c6_22,c12_22,dms_r22;
    __m256d          dx23,dy23,dz23,rsq23,rinv23,rinvsq23,r23,qq23,c6_23,c12_23,dms_r23;
    __m256d          dx31,dy31,dz31,rsq31,rinv31,rinvsq31,r31,qq31,c6_31,c12_31,dms_r31;
    __m256d          dx32,dy32,dz32,rsq32,rinv32,rinvsq32,r32,qq32,c6_32,c12_32,dms_r32;
    __m256d          dx33,dy33,dz33,rsq33,rinv33,rinvsq33,r33,qq33,c6_33,c12_33,dms_r33;
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
	    ...
	    #ifdef SHIFT_FORCES
                dms_r00     = _mm256_sqrt_pd(rsq00);
                dms_r00     = _mm256_add_pd(dms_r00, dms_epsilon);
       	        rsq00       = _mm256_mul_pd(dms_r00, dms_r00);
            #endif

            rsq11            = gmx_mm256_calc_rsq_pd(dx11,dy11,dz11);

	    #ifdef SHIFT_FORCES
                dms_r11     = _mm256_sqrt_pd(rsq11);
                dms_r11     = _mm256_add_pd(dms_r11, dms_epsilon);
       	        rsq11       = _mm256_mul_pd(dms_r11, dms_r11);
            #endif

            rsq12            = gmx_mm256_calc_rsq_pd(dx12,dy12,dz12);

	    #ifdef SHIFT_FORCES
                dms_r12     = _mm256_sqrt_pd(rsq12);
                dms_r12     = _mm256_add_pd(dms_r12, dms_epsilon);
       	        rsq12       = _mm256_mul_pd(dms_r12, dms_r12);
            #endif

            rsq13            = gmx_mm256_calc_rsq_pd(dx13,dy13,dz13);

	    #ifdef SHIFT_FORCES
                dms_r13     = _mm256_sqrt_pd(rsq13);
                dms_r13     = _mm256_add_pd(dms_r13, dms_epsilon);
       	        rsq13       = _mm256_mul_pd(dms_r13, dms_r13);
            #endif

            rsq21            = gmx_mm256_calc_rsq_pd(dx21,dy21,dz21);

	    #ifdef SHIFT_FORCES
                dms_r21     = _mm256_sqrt_pd(rsq21);
                dms_r21     = _mm256_add_pd(dms_r21, dms_epsilon);
       	        rsq21       = _mm256_mul_pd(dms_r21, dms_r21);
            #endif

            rsq22            = gmx_mm256_calc_rsq_pd(dx22,dy22,dz22);

	    #ifdef SHIFT_FORCES
                dms_r22     = _mm256_sqrt_pd(rsq22);
                dms_r22     = _mm256_add_pd(dms_r22, dms_epsilon);
       	        rsq22       = _mm256_mul_pd(dms_r22, dms_r22);
            #endif

            rsq23            = gmx_mm256_calc_rsq_pd(dx23,dy23,dz23);

	    #ifdef SHIFT_FORCES
                dms_r23     = _mm256_sqrt_pd(rsq23);
                dms_r23     = _mm256_add_pd(dms_r23, dms_epsilon);
       	        rsq23       = _mm256_mul_pd(dms_r23, dms_r23);
            #endif

            rsq31            = gmx_mm256_calc_rsq_pd(dx31,dy31,dz31);

	    #ifdef SHIFT_FORCES
                dms_r31     = _mm256_sqrt_pd(rsq31);
                dms_r31     = _mm256_add_pd(dms_r31, dms_epsilon);
       	        rsq31       = _mm256_mul_pd(dms_r31, dms_r31);
            #endif

            rsq32            = gmx_mm256_calc_rsq_pd(dx32,dy32,dz32);

	    #ifdef SHIFT_FORCES
                dms_r32     = _mm256_sqrt_pd(rsq32);
                dms_r32     = _mm256_add_pd(dms_r32, dms_epsilon);
       	        rsq32       = _mm256_mul_pd(dms_r32, dms_r32);
            #endif

            rsq33            = gmx_mm256_calc_rsq_pd(dx33,dy33,dz33);

	    #ifdef SHIFT_FORCES
                dms_r33     = _mm256_sqrt_pd(rsq33);
                dms_r33     = _mm256_add_pd(dms_r33, dms_epsilon);
       	        rsq33       = _mm256_mul_pd(dms_r33, dms_r33);
            #endif
